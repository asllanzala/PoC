...
public class EvaluateCoordinate {
    ...
    private static int[] mL1Arr = {0, 0, 0, 0, 0, 0};
    private static int[] mL2Arr = {0, 0, 0, 0, 0, 0};
    private static int[] mL3Arr = {0, 0, 0, 0, 0, 0};
    ...
    public static Point evaluate1(int r1) {
        ...
        if (mL1ArrIndex == 5) {
            ...
            Log.i(TAG, "Sensor1 avg: " + (int) (mL1Avg * MapScale.METER_PIXEL_RATIO) + "mm");
    ...
    public static Point evaluate2(int r2) {
        ...
        if (mL2ArrIndex == 5) {
            ...
            Log.i(TAG, "Sensor2 avg: " + (int) (mL2Avg * MapScale.METER_PIXEL_RATIO) + "mm");
            point = calculate(mX1, mY1, mX2, mY2, mX3, mY3,
                    BigDecimal.valueOf(mL1Avg), BigDecimal.valueOf(mL2Avg), BigDecimal.valueOf(mL3Avg));
        }
    ...
    public static Point evaluate3(int r3) {
        ...
        if (mL3ArrIndex == 5) {
            ...
            Log.i(TAG, "Sensor3 avg: " + (int) (mL3Avg * MapScale.METER_PIXEL_RATIO) + "mm");
            point = calculate(mX1, mY1, mX2, mY2, mX3, mY3,
                    BigDecimal.valueOf(mL1Avg), BigDecimal.valueOf(mL2Avg), BigDecimal.valueOf(mL3Avg));
        }
