package com.jin.honeywell.transmitter.service;
...
import com.jin.honeywell.transmitter.util.Logger.LogUtil;
...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_READ_RSSI = "com.honeywell.hch.airtouch.plateform.ble.ACTION_READ_RSSI";
    ...
    public final static String ACTION_REQEUST_MTU = "com.honeywell.hch.airtouch.plateform.ble.ACTION_REQEUST_MTU";
    ...
    private BluetoothGattCallback mBluetoothGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                if (status == 0) {
                    ...
                    LogUtil.log(LogUtil.LogLevel.INFO, TAG, "Attempting to start service discovery:" + gatt.discoverServices());
        ...
        public void onReadRemoteRssi(BluetoothGatt gatt, int rssi, int status) {
            ...
            LogUtil.log(LogUtil.LogLevel.INFO, TAG, "rssi:" + rssi);
            broadcastUpdate(ACTION_READ_RSSI, gatt.getDevice().getAddress(), rssi);
        }
        ...
        public void onMtuChanged(BluetoothGatt gatt, int mtu, int status) {
            ...
            LogUtil.log(LogUtil.LogLevel.INFO, TAG, "onMtuChanged:" + mtu);
            broadcastUpdate(ACTION_REQEUST_MTU, gatt.getDevice().getAddress(), gatt.getDevice().getName());
        }
    };
            ...
            if (action.equals(BluetoothAdapter.ACTION_STATE_CHANGED)) {
                ...
                switch (state) {
                    case BluetoothAdapter.STATE_OFF:
                        LogUtil.log(LogUtil.LogLevel.INFO, TAG, getString(R.string.no_bluetooth));
                        broadcastUpdate(ACTION_PHONE_BLUETOOTH_OFF, "", "");
                        break;
                    case BluetoothAdapter.STATE_ON:
                        LogUtil.log(LogUtil.LogLevel.INFO, TAG, getString(R.string.has_bluetooth));
...
//        }
    ...
    public void requestMtu(String address, int mtu) {
        ...
        mBluetoothGattHashMap.get(address).requestMtu(mtu);
    }
...
//        mBluetoothGattHashMap.get(address).setCharacteristicNotification(characteristic, enabled);
    ...
    public boolean readRSSIVal(String address) {
        if (mBluetoothGattHashMap == null || mBluetoothGattHashMap.get(address) == null)
            return false;

        return mBluetoothGattHashMap.get(address).readRemoteRssi();
    }
